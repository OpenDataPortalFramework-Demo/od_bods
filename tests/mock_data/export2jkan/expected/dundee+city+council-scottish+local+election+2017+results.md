...
resources:
- format: CSV
  name: Coldside Ward 2017 Election Results
...
- format: CSV
  name: East End Ward 2017 Election Results
...
- format: CSV
  name: Lochee Ward 2017 Election Results
...
- format: CSV
  name: Maryfield Ward 2017 Election Results
...
- format: CSV
  name: North East Ward 2017 Election Results
...
- format: CSV
  name: Strathmartine Ward 2017 Election Results
...
- format: CSV
  name: The Ferry Ward 2017 Election Results
...
- format: CSV
  name: West End Ward 2017 Election Results
